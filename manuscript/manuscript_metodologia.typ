...
- *Equilibración NPT* (Presión Constante): Se ejecutará durante *100 ps* a una presión de referencia constante de *1.0 bar* y temperatura de *300 K*, empleando el baróstato isotrópico de Parrinello-Rahman con un tiempo de acoplamiento de presión ($tau_p$) de 2.0 ps y una compresibilidad isotérmica de $4.5 times 10^(-5) " bar"^(-1)$.
